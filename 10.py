...
print("Задание 1")
print(stats.f_oneway(fb, hc, sht))
print(
    "pvalue < alpha, основная гипотеза H0 отвергается, принимается гипотеза H1, статистически значимые различия среднего роста есть")
